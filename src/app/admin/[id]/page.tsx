...
async function updateProductAction(formData: FormData) {
  ...
  const updates: ProductRecord = {
    ...
    // Additional image URLs (preserved from existing)
    image_url_2: existing?.image_url_2 ?? null,
    image_url_3: existing?.image_url_3 ?? null,
    image_url_4: existing?.image_url_4 ?? null,
    image_url_5: existing?.image_url_5 ?? null,
    image_url_6: existing?.image_url_6 ?? null,
    image_url_7: existing?.image_url_7 ?? null,
    image_url_8: existing?.image_url_8 ?? null,
    image_url_9: existing?.image_url_9 ?? null,
    image_url_10: existing?.image_url_10 ?? null,
    image_url_11: existing?.image_url_11 ?? null,
    image_url_12: existing?.image_url_12 ?? null,
