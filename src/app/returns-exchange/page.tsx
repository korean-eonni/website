        ...
        <FloatingIcons count={7} offset={2} />
          ...
          <div className="max-w-[800px]">
            ...
            <p className="mt-6 text-black font-gilroy text-[16px] leading-[24px] sm:text-[18px] sm:leading-[28px]">
              ...
              ми завжди готові допомогти. 14 днів на повернення товарів, які підлягають поверненню.
              Парфумерно-косметичні товари належної якості поверненню та обміну не підлягають.
            </p>
          </div>
        </div>
      </section>
