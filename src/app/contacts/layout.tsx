...
export const metadata: Metadata = {
  ...
  description:
    "Зв'яжіться з Eonni: телефон +380732737330, email support@eonni.com.ua, Instagram @eonni.korean.cosmetics. Працюємо щодня з 10:00 до 20:00. Київ, вул. Левка Лук'яненка, 21.",
