          ...
          <div className="max-w-[800px]">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Magnetic strength={12}>
                <Link
                  href="/catalog"
                  className="inline-flex h-[50px] px-8 items-center justify-center rounded-[12px] bg-[#BCC2F4] text-black uppercase font-gilroy text-[16px] font-semibold transition-colors duration-300 hover:bg-[#6046A3] hover:text-white"
                >
                  Перейти до каталогу
                </Link>
              </Magnetic>
