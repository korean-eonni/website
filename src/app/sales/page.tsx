...
const currentOffers = [
  {
    ...
    description: 'При замовленні від 1500₴ доставка Новою Поштою до відділення — безкоштовна!',
    badge: 'Постійна акція',
    tone: '#F6F1FF',
    icon: '🚚',
    conditions: 'Діє на всі замовлення від 1500₴',
  },
  {
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-[72px] xl:px-[100px]">
          <div className="rounded-[32px] bg-black text-white p-10 sm:p-14 text-center">
            ...
            <Link
              href="/catalog"
              className="mt-8 inline-flex h-[50px] px-10 items-center justify-center rounded-[12px] bg-[#BCC2F4] text-black uppercase font-gilroy text-[16px] font-semibold hover:bg-[#A8AFEB] transition-colors"
            >
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr,1.2fr] items-center">
            ...
            <div className="grid gap-4">
              {upcomingOffers.map((offer) => (
                <div
                  key={offer.title}
                  className="rounded-[20px] bg-white p-6 border border-[#E5E5E5] flex items-center gap-6"
                >
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-[72px] xl:px-[100px]">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {savingTips.map((tip) => (
              <div
                key={tip.title}
                className="rounded-[24px] border border-[#E5E5E5] bg-white p-6 text-center hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)] transition-shadow"
              >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {brands.map((brand) => (
              <Link
                ...
                className="px-6 py-3 rounded-full bg-white border border-[#E5E5E5] text-[15px] font-gilroy text-black hover:bg-[#BCC2F4] hover:border-[#BCC2F4] transition-colors"
              >
                {brand}
              </Link>
            ))}
