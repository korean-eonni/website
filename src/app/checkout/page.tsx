      ...
      <main className="min-h-screen bg-[#E2F9FF]">
        <section className="py-20">
          <div className="max-w-[600px] mx-auto px-6 text-center">
            <div className="w-12 h-12 mx-auto mb-6 border-4 border-[#6046A3] border-t-transparent rounded-full animate-spin" />
                ...
                {step === 3 && (
                  <div>
                    ...
                    <div className="space-y-3 mb-8">
                      ...
                      <label className={`flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition-colors ${
                        paymentMethod === 'platon' ? 'border-[#6046A3] bg-[#F5F3FF]' : 'border-[#E5E5E5] hover:border-[#BBBBBB]'
                      }`}>
                        <input
                          type="radio"
                          name="payment"
