        ...
        <div className="max-w-[800px] mx-auto px-6">
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <Link href="/account" className="text-[#4348AE] hover:underline">
                Перейти до акаунта
              </Link>
            </div>
          ) : !order ? (
            <div className="text-center py-20">
              ...
              <Link href="/account?tab=orders" className="text-[#4348AE] hover:underline">
                До моїх замовлень
              </Link>
            </div>
          ) : (
            <>
              ...
              <Link
                ...
                className="inline-flex items-center gap-1 text-[14px] text-[#4348AE] hover:underline mb-6"
              >
                ← До моїх замовлень
              </Link>
                  ...
                  <div>
                    ...
                    {order.tracking_number && (
                      <p className="text-[14px] mt-2">
                        ...
                        <span className="text-[#4348AE] font-medium">{order.tracking_number}</span>
                      </p>
                    )}
                  </div>
                  <div>
