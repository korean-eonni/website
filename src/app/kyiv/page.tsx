...
export const metadata: Metadata = {
  ...
  description:
    'Купити корейську косметику в Києві з доставкою в день замовлення. Магазин Eonni: оригінальна K-beauty від Medicube, Mediheal, Torriden, UNOVE, VT Cosmetics. Доставка по всій Україні Новою Поштою і Укрпоштою.',
  keywords: [
