...
export const metadata: Metadata = {
  ...
  description:
    'Купити корейську косметику в Києві з відправленням у день замовлення. Магазин Eonni: оригінальна K-beauty від Medicube, Mediheal, Torriden, UNOVE, VT Cosmetics. Доставка по всій Україні Новою Поштою і Укрпоштою.',
  keywords: [
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text:
          'Оберіть товари в каталозі Eonni, додайте в кошик, оформіть замовлення та виберіть зручний спосіб доставки Новою Поштою по всій Україні.',
      },
    },
    {
      '@type': 'Question',
        ...
        <div className="max-w-[1200px] mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 font-gilroy text-[15px] leading-[22px] text-[#4A5061]">
                Склад у Києві — повна наявність товарів. Відправлення Новою Поштою в будь-який район та місто України
                у день замовлення.
              </p>
            </div>
            <div>
