  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text:
          'Medicube, Mediheal, Torriden, UNOVE, LACTOFIT, VITAHALO, VT Cosmetics, PROBIODERM, CJ WELLCARE, INNERLAB, ARDIEM — офіційно з Кореї, з повним складом у Києві.',
      },
    },
  ],
}
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-[1200px] mx-auto px-6 sm:px-8 lg:px-12 grid gap-6 md:grid-cols-3">
          <div className="bg-white rounded-[20px] p-6 sm:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
            <p className="text-[14px] uppercase tracking-[0.15em] text-[#6046A3] font-semibold">
              Адреса
            </p>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 font-gilroy text-[15px] leading-[22px] text-[#4A5061]">
                ...
                Torriden, UNOVE, VT&nbsp;Cosmetics, LACTOFIT, VITAHALO, PROBIODERM,
