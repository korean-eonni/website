    ...
    <div className="relative" ref={dropdownRef}>
      <Magnetic strength={10}>
        <button
          ...
          className="relative w-10 h-10 rounded-full bg-[#1B1340] text-white flex items-center justify-center hover:bg-[#6046A3] transition-colors duration-300"
          aria-label="Кошик"
        >
          ...
          <AnimatePresence mode="wait">
            {itemCount > 0 && (
              <motion.span
                ...
                className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 bg-[#6046A3] text-white text-[10px] leading-none font-semibold rounded-full flex items-center justify-center ring-2 ring-[#FFFCF5]"
              >
