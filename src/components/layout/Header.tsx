...
export default function Header() {
  ...
  const iconButtonClass =
    'w-10 h-10 flex items-center justify-center rounded-full text-black hover:text-[#6046A3] transition-colors duration-300'
              ...
              {navLinks.map((link) => (
                ...
                >
                  <Link
                    ...
                    className={
                      link.href === '/skin-test'
                        ? 'inline-flex flex-col items-center text-center rounded-full bg-[#6046A3] text-white px-3.5 py-1 hover:bg-[#4D3882] transition-colors duration-200 shadow-[0_2px_8px_rgba(96,70,163,0.3)]'
                        : 'text-black hover:text-[#6046A3] transition-colors duration-200'
                    }
                  >
                    {link.href === '/skin-test' ? (
                      <>
                      ...
                      >
                        {link.dropdownItems.map((item) => (
                          <Link
                            ...
                            className="block px-4 py-2 text-[15px] text-black hover:text-[#6046A3] hover:translate-x-1 transition-all duration-200"
                          >
                            {item.label}
                          </Link>
                        ))}
                            ...
                            <div key={cat.label}>
                              <div className="flex items-center gap-1 px-2">
                                <Link
                                  ...
                                  className="flex-1 px-2 py-2 text-[15px] text-black hover:text-[#6046A3] transition-colors duration-200"
                                >
                                  {cat.label}
                                </Link>
                                {hasSubs && (
                                  <button
                                    ...
                                    className="flex-shrink-0 w-5 h-5 flex items-center justify-center text-[#6046A3] hover:text-[#3B2C66] transition-colors duration-200"
                                  >
            ...
            <div className="flex items-center gap-1 sm:gap-2 ml-auto">
              ...
              >
                ...
                >
                  ...
                  >
                    <Link href="/account" onClick={() => setOpenDropdown(null)} className="block px-4 py-2 text-[15px] text-black hover:text-[#6046A3] hover:translate-x-1 transition-all duration-200">Профіль</Link>
                    <Link href="/account?tab=orders" onClick={() => setOpenDropdown(null)} className="block px-4 py-2 text-[15px] text-black hover:text-[#6046A3] hover:translate-x-1 transition-all duration-200">Мої замовлення</Link>
                    <Link href="/account?tab=wishlist" onClick={() => setOpenDropdown(null)} className="block px-4 py-2 text-[15px] text-black hover:text-[#6046A3] hover:translate-x-1 transition-all duration-200">Список бажань</Link>
                  </div>
                </div>
              </div>
              ...
              <Magnetic strength={10}>
                <button
                  ...
                  className="lg:hidden w-10 h-10 flex items-center justify-center rounded-full text-black hover:text-[#6046A3] transition-colors duration-300"
          ...
          >
            <form onSubmit={handleSearch} className="flex gap-3">
              <input
                ...
                className="flex-1 h-14 px-5 border border-[#E5E5E5] rounded-xl text-[16px] outline-none focus:border-[#6046A3] transition-colors bg-white"
              />
          ...
          >
            <div className="absolute top-0 left-0 right-0 px-4 sm:px-6 pt-5 flex items-center justify-end">
              <button
                ...
                className="w-10 h-10 flex items-center justify-center rounded-full text-black hover:text-[#6046A3] transition-colors duration-300"
                    ...
                    >
                      <div className="flex items-center justify-between gap-4">
                        <Link
                          href={item.href}
                          onClick={() => setMobileMenuOpen(false)}
                          className={`block font-bebas uppercase text-[36px] sm:text-[48px] leading-[1.05] tracking-[0.01em] hover:translate-x-2 hover:text-[#6046A3] transition-all duration-300 ${
                            item.href === '/skin-test' ? 'text-[#6046A3]' : 'text-black'
                          }`}
                        >
                          {item.href === '/skin-test' ? (
                            <span className="flex flex-col">
                              <span className="font-gilroy normal-case tracking-normal text-[14px] sm:text-[16px] text-[#6046A3]/80 mb-1">
                                Який в тебе тип шкіри?
                              </span>
                            ...
                            <div className="pl-2 pt-3 pb-1 flex flex-col gap-2.5">
                              {item.children.map((sub) => (
                                <Link
                                  ...
                                  href={sub.href}
                                  onClick={() => setMobileMenuOpen(false)}
                                  className="block font-gilroy text-[16px] sm:text-[18px] text-black/75 hover:text-[#6046A3] transition-colors"
                                >
                                  {sub.label}
                                </Link>
                              ))}
