            ...
            <div className="flex items-center gap-3 mt-6">
              <Magnetic strength={10}>
                <a
                  ...
                  aria-label="Email"
                  className="w-11 h-11 rounded-full flex items-center justify-center bg-[#E2F9FF] text-black hover:bg-[#6046A3] hover:text-white transition-colors duration-300"
                >
