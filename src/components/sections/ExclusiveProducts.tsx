...
export default function ExclusiveProducts({ products }: ExclusiveProductsProps) {
  ...
  return (
    <section className="relative bg-[#E2F9FF] py-16 sm:py-20 overflow-hidden">
      <FloatingIcons count={7} offset={11} />
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6 sm:mb-10">
          ...
          <Magnetic strength={12}>
            <Link
              ...
              className="inline-flex items-center justify-center bg-[#BCC2F4] hover:bg-[#A8B0E8] text-black font-semibold text-[14px] sm:text-[15px] tracking-[0.05em] px-6 sm:px-10 py-3 sm:py-4 rounded-[12px] transition-colors duration-300 uppercase self-start"
            >
              Купити
            </Link>
          </Magnetic>
