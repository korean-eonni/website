...
export default function ExclusiveProducts({ products }: ExclusiveProductsProps) {
  ...
  return (
    <section className="relative bg-white py-16 sm:py-20 overflow-hidden">
      <FloatingIcons count={6} offset={11} />
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-[72px] xl:px-[100px]">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6 sm:mb-10">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center bg-[#BCC2F4] hover:bg-[#A8B0E8] text-black font-semibold text-[14px] sm:text-[15px] tracking-[0.05em] px-6 sm:px-10 py-3 sm:py-4 rounded-[12px] transition-colors uppercase self-start"
          >
            Купити
          </Link>
        </div>
