...
const items: Item[] = [
  {
    ...
    icon: (
      <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#6046A3" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
          {items.map((item) => (
            ...
            >
              ...
              <div className="absolute top-7 right-7 w-9 h-9 rounded-full bg-[#6046A3] text-white flex items-center justify-center opacity-100 md:opacity-0 md:-translate-x-2 md:group-hover:opacity-100 md:group-hover:translate-x-0 md:group-focus-visible:opacity-100 md:group-focus-visible:translate-x-0 transition-[opacity,transform] duration-300">
