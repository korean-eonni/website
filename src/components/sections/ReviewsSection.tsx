...
function StarIcon({ filled }: { filled: boolean }) {
  return (
    <svg
      ...
      height="16"
      viewBox="0 0 24 24"
      fill={filled ? '#6046A3' : 'none'}
      stroke={filled ? '#6046A3' : '#C9C5DA'}
      strokeWidth="1.6"
      strokeLinecap="round"
  ...
  return (
    <section className="relative bg-[#E2F9FF] py-16 sm:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-[72px] xl:px-[100px]">
        ...
        {/* Success Message */}
        {submitted && (
          <div className="mb-8 px-5 py-4 bg-white border border-[#6046A3]/15 rounded-2xl flex items-center gap-3 shadow-[0_6px_20px_rgba(96,70,163,0.08)]">
            <span className="w-9 h-9 rounded-full bg-[#6046A3] text-white flex items-center justify-center flex-shrink-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-[52px] px-5 bg-white rounded-full border border-[#E5E5E5] text-[15px] outline-none focus:border-[#6046A3] focus:shadow-[0_4px_18px_rgba(96,70,163,0.12)] transition-[border-color,box-shadow] duration-300"
                    style={{ fontFamily: 'Gilroy, sans-serif' }}
                    ...
                    <button
                      ...
                      className={`w-11 h-11 rounded-full flex items-center justify-center transition-[background-color,border-color,box-shadow] duration-200 ${
                        formData.rating >= star
                          ? 'bg-[#6046A3] shadow-[0_4px_14px_rgba(96,70,163,0.32)]'
                          : 'bg-white border border-[#E5E5E5] hover:border-[#6046A3]/40'
                      }`}
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-5 py-4 bg-white border border-[#E5E5E5] rounded-[20px] text-[15px] outline-none focus:border-[#6046A3] focus:shadow-[0_4px_18px_rgba(96,70,163,0.12)] transition-[border-color,box-shadow] duration-300 resize-none"
                  style={{ fontFamily: 'Gilroy, sans-serif' }}
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  type="submit"
                  className="h-[50px] px-8 bg-black hover:bg-[#6046A3] hover:shadow-[0_8px_24px_rgba(96,70,163,0.32)] text-white rounded-full font-gilroy text-[14px] uppercase tracking-wider font-semibold transition-[background-color,box-shadow] duration-300"
                >
                  Надіслати відгук
                </button>
                <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {reviews.map((review) => (
            ...
            >
              ...
              <span
                aria-hidden
                className="absolute top-5 right-6 font-bebas text-[80px] leading-none text-[#6046A3]/8 select-none pointer-events-none"
              >
                “
              </span>
              ...
              <div className="flex items-center gap-3 pt-5 border-t border-black/8">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-gilroy text-[12px] text-[#6046A3]/80 flex items-center gap-1">
        ...
        <div className="mt-12 text-center">
          <Link
            href="/catalog"
            className="inline-flex items-center gap-2 font-gilroy text-[14px] uppercase tracking-wider font-semibold text-[#6046A3] hover:text-black transition-colors"
          >
