          ...
          <div className="w-full max-w-[640px] flex flex-col items-center">
            ...
            {submitted ? (
              <div className="mt-9 flex flex-col items-center gap-3">
                <div className="w-[60px] h-[60px] rounded-full bg-[#4348AE] flex items-center justify-center shadow-[0_8px_24px_rgba(96,70,163,0.35)]">
              ...
              <form onSubmit={handleSubmit} className="w-full flex flex-col items-center mt-8">
                ...
                >
                  ...
                  <span
                    aria-hidden
                    className="absolute top-1 bottom-1 left-1 w-[calc(50%-4px)] rounded-full bg-[#4348AE] transition-transform duration-300 ease-out"
                  ...
                  {mode === 'email' ? (
                    <>
                      ...
                      <input
                        ...
                        className="w-full h-[54px] rounded-full pl-[22px] pr-[22px] text-[16px] leading-[24px] bg-white border border-white/80 shadow-[0_4px_16px_rgba(96,70,163,0.08)] text-black placeholder:text-black/40 outline-none focus:border-[#4348AE] focus:shadow-[0_6px_24px_rgba(96,70,163,0.18)] transition-[border-color,box-shadow] duration-300"
                    ...
                    <>
                      ...
                      <input
                        ...
                        placeholder="** *** ** **"
                        className="w-full h-[54px] rounded-full pl-[72px] pr-[22px] text-[16px] leading-[24px] bg-white border border-white/80 shadow-[0_4px_16px_rgba(96,70,163,0.08)] text-black placeholder:text-black/40 outline-none focus:border-[#4348AE] focus:shadow-[0_6px_24px_rgba(96,70,163,0.18)] transition-[border-color,box-shadow] duration-300 tracking-wide"
                        style={{ fontFamily: 'Gilroy, sans-serif' }}
                      />
                    </>
                  )}
                ...
                <Magnetic strength={12}>
                  <button
                    type="submit"
                    className="mt-5 inline-flex h-[54px] px-10 items-center justify-center rounded-full bg-black text-white uppercase font-gilroy text-[15px] font-semibold tracking-wider transition-[background-color,box-shadow] duration-300 hover:bg-[#4348AE] hover:shadow-[0_8px_28px_rgba(96,70,163,0.35)]"
                  >
                    Підписатись
                  </button>
                </Magnetic>
