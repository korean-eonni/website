  ...
  return (
    <div className="relative group">
      <button
        ...
        className="relative w-[56px] h-[56px] sm:w-[64px] sm:h-[64px] rounded-full overflow-hidden flex items-center justify-center text-white text-[20px] sm:text-[24px] font-semibold bg-gradient-to-br from-[#BCC2F4] to-[#4842AB]"
      >
        {src ? (
      ...
      <button
        ...
        className="absolute bottom-0 right-0 w-6 h-6 sm:w-[26px] sm:h-[26px] rounded-full bg-[#4348AE] border-2 border-white text-white flex items-center justify-center shadow-md hover:bg-[#373B8A] transition-colors"
      >
